...
public class RedisHelper extends RedisTemplate {
    ...
    void init() {
        ...
        StaticLog.debug("RedisHelper 初始化完成，静态模板已注入");
    }

    /* --------------------key相关操作--------------------- */

    public static void delete(Collection<String> keys) {
        StaticLog.debug("批量删除key: {}", keys);
        redisTemplate.delete(keys);
    }

    public static void delete(String key) {
        StaticLog.debug("删除key: {}", key);
        redisTemplate.delete(key);
    }

    public static Boolean hasKey(String key) {
        StaticLog.debug("是否存在key: {}", key);
    ...
    public static Boolean expire(String key,
                                 long timeout,
                                 TimeUnit unit) {
        StaticLog.debug("设置key的过期时间: {}", key);
        return redisTemplate.expire(key, timeout, unit);
    }

    public static Set<String> keys(String pattern) {
        StaticLog.debug("获取匹配的key: {}", pattern);
        return redisTemplate.keys(pattern);
    }

    public static Long getExpire(String key,
                                 TimeUnit unit) {
        StaticLog.debug("获取key的剩余时间: {}", key);
    ...
    public static void setEx(String key,
                             ...
                             long timeout,
                             TimeUnit unit) {
        StaticLog.debug("设置key的值: {} ，并设置过期时间: {}", key, timeout);
        redisTemplate.opsForValue()
                .set(key, value, timeout, unit);
    }

    public static void set(String key, String value) {
        StaticLog.debug("设置key的值: {}", key);
        redisTemplate.opsForValue()
                .set(key, value);
    }

    public static String get(String key) {
        StaticLog.debug("获取key的值: {}", key);
    ...
    public static void send(String channelName,
        ...
        StaticLog.debug("已发布消息: {}: 到渠道: {}", message, channelName);
    }
}
